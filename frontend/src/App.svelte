<script>
  ...
  import FlightNotesPanel from "./lib/components/FlightNotesPanel.svelte";
  ...
  } from "./lib/utils/flightDetailsState.js";
  import {
    loadUserPreferences,
        ...
        {#if selectedFlight}
          {#if inspectorTab === "details"}
            <FlightDetailsPanel
              ...
              onClose={() => clearSelectedFlight({ closeSidebar: true })}
            >
              <div slot="afterHero" class="inspector-tab-row inspector-tab-row-inline" role="tablist" aria-label="Selected aircraft sections">
                <button
          ...
          {:else if inspectorTab === "notes"}
            ...
            <FlightNotesPanel
              ...
              onNotesChange={updateSelectedFlightNotes}
              onTagDraftChange={(value) => {
                selectedTagDraft = value;
              }}
              onSubmitTag={submitSelectedFlightTag}
...
<style>
  ...
  .radar-right-panel.selected-flight-inspector {
    grid-template-rows: minmax(0, 1fr);
  }
